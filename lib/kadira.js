...
Kadira.initMetric = ({
  ...
  Kadira.models.custom.initMetric(name, type);
}

/**
 * 
 * @param {object} data
 * @param {string} data.name Metric name to increment
 * @param {string} data.amount Amount to increment, can be postive or negative
 */
Kadira.incMetric = ({
  name,
  amount
